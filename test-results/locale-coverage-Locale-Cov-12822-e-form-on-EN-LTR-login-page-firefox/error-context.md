...
- Name: locale-coverage.spec.ts >> Locale Coverage — FA/RTL & EN/LTR >> Accessibility — Both Locales >> should have accessible form on EN/LTR login page
- Location: apps/web/e2e/locale-coverage.spec.ts:236:9
