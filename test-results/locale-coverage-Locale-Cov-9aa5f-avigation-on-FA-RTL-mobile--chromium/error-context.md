...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    - banner [ref=e3]:
      - generic [ref=e4]:
        - generic [ref=e10]:
          - paragraph [ref=e11]: کستامینوفن
          - paragraph [ref=e12]: کشف، گوش دادن و بازگشت در یک تجربه‌ی روشن و بتا
        - generic [ref=e13]:
          - link "جستجو در پادکست‌ها" [ref=e14] [cursor=pointer]:
            - /url: /fa/search
          - link "تنظیمات برنامه" [ref=e18] [cursor=pointer]:
            - /url: /fa/settings
          - link "پروفایل کاربری" [ref=e23] [cursor=pointer]:
            - /url: /fa/profile
    - main [ref=e27]:
      - main [ref=e30]:
        - region [ref=e31]:
          - generic [ref=e32]:
            - generic [ref=e33]:
              - generic [ref=e34]: CASTAMINOFEN
              - generic [ref=e39]:
                - paragraph [ref=e40]: برای شروع، کشف صداهای تازه
                - heading "شروعی ساده برای کشف و شنیدن پادکست‌های مورد علاقه‌ات" [level=1] [ref=e41]
                - paragraph [ref=e42]: پادکست‌هایی را پیدا کن که با حال‌وهوایت همراه می‌شوند و شنیدن را با تمرکز و آرامش شروع کن.
              - generic [ref=e43]:
                - link "شروع کردن" [ref=e44] [cursor=pointer]:
                  - /url: /login
                - link "کشف پادکست‌ها" [ref=e47] [cursor=pointer]:
                  - /url: /podcasts
              - paragraph [ref=e52]: اینجا برای کشف و شنیدن پادکست‌هاست؛ بدون شلوغی و حواس‌پرتی.
            - generic [ref=e53]: کشف صداهای تازه
        - region [ref=e64]:
          - generic [ref=e65]:
            - paragraph [ref=e66]: کشف کن
            - heading "پادکست‌هایی برای شروع" [level=2] [ref=e67]
            - status "در حال بارگذاری پادکست‌ها" [ref=e68]
    - generic [ref=e73]:
      - generic [ref=e74]:
        - generic [ref=e75]:
          - generic [ref=e76]:
            ...
            - generic [ref=e80]:
              - generic [ref=e81]:
                - paragraph [ref=e82]: No active playback
                - generic [ref=e83]: متوقف
              - paragraph [ref=e84]: پخش در دسترس است
          - paragraph [ref=e85]: برای شروع، اپیزودی را انتخاب کنید.
        - generic [ref=e87]:
          - group "Playback controls" [ref=e88]:
            - button "پخش مورد قبلی" [disabled]
            - button "شروع پخش" [disabled]
            - button "توقف پخش" [disabled]
            - button "تصادفی خاموش" [ref=e89] [cursor=pointer]
            - button "تکرار خاموش" [ref=e97] [cursor=pointer]
            - button "پخش مورد بعدی" [disabled]
          - generic [ref=e104]:
            - button "باز کردن صف پخش" [ref=e105] [cursor=pointer]:
              - generic [ref=e106]: صف پخش
            - button "گسترش پخش‌کننده" [ref=e109] [cursor=pointer]:
              - generic [ref=e110]: پخش تعاملی
      - generic [ref=e112]:
        - generic [ref=e113]: 00:00
        - progressbar "Playback progress" [ref=e115]
        - generic [ref=e117]: مدت نامشخص
    - navigation "ناوبری اصلی" [ref=e118]:
      - generic [ref=e120]:
        - link "خانه" [ref=e121] [cursor=pointer]:
          - /url: /fa
        - link "کتابخانه" [ref=e127] [cursor=pointer]:
          - /url: /fa/library
        - link "ایجاد" [ref=e132] [cursor=pointer]:
          - /url: /fa/create
        - link "جستجو" [ref=e136] [cursor=pointer]:
          - /url: /fa/search
        - link "اجتماع" [ref=e142] [cursor=pointer]:
          - /url: /fa/community
        - link "پروفایل" [ref=e150] [cursor=pointer]:
          - /url: /fa/profile
  - alert [ref=e156]
```
