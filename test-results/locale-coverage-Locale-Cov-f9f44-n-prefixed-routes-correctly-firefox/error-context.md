...
Error: strict mode violation: locator('main') resolved to 2 elements:
    1) <main class="flex-1">…</main> aka getByRole('main').first()
    2) <main class="w-full bg-surface-canvas">…</main> aka getByRole('main').nth(1)
    ...
    - main [ref=e54]:
      - main [ref=e57]:
        - region [ref=e58]:
          - generic [ref=e59]:
            - generic [ref=e60]:
              - generic [ref=e61]: CASTAMINOFEN
              - generic [ref=e66]:
                - paragraph [ref=e67]: برای شروع، کشف صداهای تازه
                - heading "شروعی ساده برای کشف و شنیدن پادکست‌های مورد علاقه‌ات" [level=1] [ref=e68]
                - paragraph [ref=e69]: پادکست‌هایی را پیدا کن که با حال‌وهوایت همراه می‌شوند و شنیدن را با تمرکز و آرامش شروع کن.
              - generic [ref=e70]:
                - link "شروع کردن" [ref=e71] [cursor=pointer]:
                  - /url: /login
                - link "کشف پادکست‌ها" [ref=e75] [cursor=pointer]:
                  - /url: /podcasts
              - paragraph [ref=e80]: اینجا برای کشف و شنیدن پادکست‌هاست؛ بدون شلوغی و حواس‌پرتی.
            - generic [ref=e81]: کشف صداهای تازه
        - region [ref=e92]:
          - generic [ref=e93]:
            - paragraph [ref=e94]: کشف کن
            - heading "پادکست‌هایی برای شروع" [level=2] [ref=e95]
            - status "در حال بارگذاری پادکست‌ها" [ref=e96]
    - generic [ref=e102]:
      - generic [ref=e103]:
        - generic [ref=e104]:
          - generic [ref=e105]: EP
          - generic [ref=e108]:
            - generic [ref=e109]:
              - paragraph [ref=e110]: No active playback
              - generic [ref=e111]: متوقف
            - paragraph [ref=e112]: پخش در دسترس است
        - paragraph [ref=e113]: برای شروع، اپیزودی را انتخاب کنید.
      - generic [ref=e114]:
        - generic [ref=e115]:
          - group "Playback controls" [ref=e116]:
            - button "پخش مورد قبلی" [disabled]
            - button "شروع پخش" [disabled]
            - button "توقف پخش" [disabled]
            - button "تصادفی خاموش" [ref=e117] [cursor=pointer]
            - button "تکرار خاموش" [ref=e125] [cursor=pointer]
            - button "پخش مورد بعدی" [disabled]
          - generic [ref=e132]:
            - button "باز کردن صف پخش" [ref=e133] [cursor=pointer]:
              - generic [ref=e134]: صف پخش
            - button "گسترش پخش‌کننده" [ref=e141] [cursor=pointer]:
              - generic [ref=e142]: پخش تعاملی
            - slider "Playback volume" [disabled] [ref=e149] [cursor=pointer]: "0.8"
        - generic [ref=e151]:
          - generic [ref=e152]: 00:00
          - progressbar "Playback progress" [ref=e154]
          - generic [ref=e156]: مدت نامشخص
  - alert [ref=e157]
```
