...
- generic [ref=e2]:
  - banner [ref=e3]:
    - generic [ref=e4]:
      ...
      - generic [ref=e13]:
        - link "Create a new podcast" [ref=e14]:
          - /url: /en/podcasts/new
        - link "Search podcasts" [ref=e16]:
          - /url: /en/search
        - link "User profile" [ref=e20]:
          - /url: /en/profile
  - main [ref=e24]:
    - status [ref=e27]:
      - paragraph [ref=e33]: Checking session...
  - generic [ref=e35]:
    - generic [ref=e36]:
      - generic [ref=e37]:
        - generic [ref=e38]:
          ...
          - generic [ref=e42]:
            - generic [ref=e43]:
              - paragraph [ref=e44]: No active playback
              - generic [ref=e45]: آماده
            - paragraph [ref=e46]: برای شروع، اپیزودی را انتخاب کنید.
        - paragraph [ref=e47]: برای شروع، اپیزودی را انتخاب کنید.
      - generic [ref=e49]:
        - group "Playback controls" [ref=e50]:
          - button "پخش مورد قبلی" [disabled]
          - button "شروع پخش" [disabled]
          - button "توقف پخش" [disabled]
          - button "تصادفی خاموش" [ref=e51] [cursor=pointer]
          - button "تکرار خاموش" [ref=e59] [cursor=pointer]
          - button "پخش مورد بعدی" [disabled]
        - generic [ref=e66]:
          - button "باز کردن صف پخش" [ref=e67] [cursor=pointer]:
            - generic [ref=e68]: صف پخش
          - button "گسترش پخش‌کننده" [ref=e71] [cursor=pointer]:
            - generic [ref=e72]: پخش تعاملی
    - generic [ref=e74]:
      - generic [ref=e75]: 00:00
      - progressbar "Playback progress" [ref=e77]
      - generic [ref=e79]: مدت نامشخص
  - navigation "ناوبری اصلی" [ref=e80]:
    - generic [ref=e82]:
      - link "Home" [ref=e83]:
        - /url: /en
      - link "Library" [ref=e89]:
        - /url: /en/library
      - link "Create" [ref=e94]:
        - /url: /en/create
      - link "Search" [ref=e98]:
        - /url: /en/search
      - link "Community" [ref=e104]:
        - /url: /en/community
      - link "Profile" [ref=e112]:
        - /url: /en/profile
```
