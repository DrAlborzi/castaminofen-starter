          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl space-y-3">
              ...
              <p className="m-0 text-body">
                اینجا مسیر خلق، پیش‌نمایش، انتشار و بازگشت به جامعه در یک تجربه‌ی حرفه‌ای و آرام برای سازنده‌ها جمع شده است؛ هر قدم در اینجا، به‌خاطر کاربر، مخاطب و حس ماندگاریِ اثر معنا دارد.
              </p>
            </div>
